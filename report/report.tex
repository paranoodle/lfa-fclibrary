...
\begin{document}
  ...
  \section{Utilisation}
    ...
    \subsection{Interaction avec images}
      Le module \texttt{fc\_images} permet de facilement tester les méthodes k-means ou c-means sur une image de votre choix. Pour une image \texttt{test.png}, il serait lancé tel que:

      {\centering
        \texttt{python fc\_images.py X test Y}
      \par}
