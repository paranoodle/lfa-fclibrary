...
\begin{document}
  ...
  Pour mettre en place C-means, nous avons chercher plusieurs documents,
  à notre grande surprise les données formules étaient souvent un peu différentes.
  ...
  manuellement nous a pousser à connaître ces algorithmes de manières très détaillées.
  Nous avons malheureu
  Il a était très intéressant de pouvoir les appliquer sur le Iris Dataset, mais également sur des images.
